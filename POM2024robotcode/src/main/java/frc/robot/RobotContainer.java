...
// Joysticks
  ...
  private RobotContainer() {
    ...
    leftledSubsystem.setDefaultCommand((new ConditionalCommand(leftledSubsystem.setLedCommand(Color.kOrange),
     leftledSubsystem.setLedCommand(POM_PURPLE), () -> transferSubsystem.isNoteIn()).
     andThen(new WaitCommand(0.2))).repeatedly());

     rightLedSubsystem.setDefaultCommand((new ConditionalCommand(rightLedSubsystem.setLedCommand(Color.kOrange), leftledSubsystem.setLedCommand(POM_PURPLE), () -> transferSubsystem.isNoteIn()).andThen(new WaitCommand(0.2))).repeatedly());
  ...
  public Command intakeNoteCommand()
  {
    return new ConditionalCommand(
        ...
        null, () -> !intakeLiftSubsystem.isOpen())
        .andThen(shootingArmSubsystem.goToAngleCommand(new TrapezoidProfile.State(GET_FROM_INTAKE_POS,0))).
        andThen(intakeRollerSubsystem.intakeNoteCommand().deadlineWith(transferSubsystem.getFromIntake()));
  }
