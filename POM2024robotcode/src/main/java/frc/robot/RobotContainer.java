...
// Joysticks
  ...
  private void configureButtonBindings() {
    ...
    new Trigger(operateCommandJoystick.button(A)).onTrue(intakeRollerSubsystem.intakeNoteCommand().raceWith(transferSubsystem.getFromIntake()));
    ...
    new Trigger(operateCommandJoystick.axisGreaterThan(LEFT_TRIGGER, THRESHOLD)).onTrue(transferSubsystem.transfer(true));
