...
// Joysticks
  ...
  private void configureButtonBindings() {
    ...
    new Trigger(operateCommandJoystick.povRight()).onTrue(shootingArmSubsystem.testtt(0.85)); 
    new Trigger(operateCommandJoystick.povLeft()).onTrue(shootingArmSubsystem.testtt(0)); 
