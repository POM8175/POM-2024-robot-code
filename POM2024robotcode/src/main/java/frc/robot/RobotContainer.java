...
// Joysticks
  ...
  private void configureButtonBindings() {
    ...
    new Trigger(operateCommandJoystick.axisGreaterThan(RB, THRESHOLD)).onTrue(shootingSubsystem.stopWheelsCommand());
    ...
    new Trigger(driverCommandJoystick.button(X)).onTrue(new TurnToSpeaker(driveSubsystem));
