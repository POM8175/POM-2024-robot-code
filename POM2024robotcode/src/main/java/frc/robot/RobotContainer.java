...
// 
  ...
  private void configureButtonBindings() {
    ...
    // Create some buttons
    new Trigger(driverCommandJoystick.button(A)).onTrue(driveSubsystem.sysIdDynamic(SysIdRoutine.Direction.kForward));
    new Trigger(driverCommandJoystick.button(B)).onTrue(driveSubsystem.sysIdDynamic(SysIdRoutine.Direction.kReverse));
    new Trigger(driverCommandJoystick.button(X)).onTrue(driveSubsystem.sysIdQuasistatic(SysIdRoutine.Direction.kForward));
    new Trigger(driverCommandJoystick.button(Y)).onTrue(driveSubsystem.sysIdQuasistatic(SysIdRoutine.Direction.kReverse));
