...
// Joysticks
  ...
  private boolean finished_climb;
  ...
  private RobotContainer() {
    ...
    ledSubsystem.setDefaultCommand(new ConditionalCommand(ledSubsystem.setLedCommand(POM_PURPLE), new ConditionalCommand(ledSubsystem.setLedCommand(Color.kOrange), ledSubsystem.setLedCommand(Color.kBlack), () -> transferSubsystem.isNoteIn()), () -> finished_climb));
  ...
  private void configureButtonBindings() {
    ...
    // new Trigger(operateCommandJoystick.button(START)).whileTrue(climb());
    // new Trigger(operateCommandJoystick.button(BACK)).onTrue(armLockSubsystem.TurnTo(OPEN_ANGLE));
    new Trigger(operateCommandJoystick.button(START)).onTrue(Commands.print("intake").andThen(intakeLiftSubsystem.OpenCloseIntakeTimers(true)));
    new Trigger(operateCommandJoystick.button(BACK)).onTrue(Commands.print("intake").andThen(intakeLiftSubsystem.OpenCloseIntakeTimers(false)));
  ...
  {
    return shootingArmSubsystem.OpenForIntakeCommand().andThen(intakeLiftSubsystem.OpenCloseIntakeTimers(false));
  }
