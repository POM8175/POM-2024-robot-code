...
// Joysticks
  ...
  private void configureButtonBindings() {
    ...
    new Trigger(operateCommandJoystick.button(8)).onTrue(armLockSubsystem.TurnTo(60));
    new Trigger(operateCommandJoystick.button(7)).onTrue(armLockSubsystem.TurnTo(120));
