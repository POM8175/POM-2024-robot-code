...
// Joysticks
  ...
  private RobotContainer() {
    ...
    driveSubsystem.setDefaultCommand(driveSubsystem.arcadeDriveCommand(() -> driverCommandJoystick.getRawAxis(RIGHT_JOYSTICK_Y), () -> driverCommandJoystick.getRawAxis(LEFT_TRIGGER) - driverCommandJoystick.getRawAxis(RIGHT_TRIGGER), driverCommandJoystick.button(A)));
  ...
  private void configureButtonBindings() {
    ...
    new Trigger(operateCommandJoystick.povDown()).onTrue(intakeLiftSubsystem.OpenCloseIntake(true)); 
    new Trigger(operateCommandJoystick.povUp()).onTrue(intakeLiftSubsystem.OpenCloseIntake(false)); 
